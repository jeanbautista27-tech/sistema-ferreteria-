                        ...
                        <tbody>
                            {ventas.map(v => (
                                <tr key={v.id}>
                                    ...
                                    <td style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{formatDateTime(v.created_at || v.createdAt)}</td>
                    ...
                    <div className="modal modal-lg" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <div className="form-row" style={{ marginBottom: 12 }}>
                                ...
                                <div><div style={{ fontSize: 12, color: 'var(--text-muted)' }}>Fecha</div><div>{formatDateTime(detalle.created_at || detalle.createdAt)}</div></div>
